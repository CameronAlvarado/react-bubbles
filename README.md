...
It is given by the server to the client when the server knows the client has been authorized. Can be stored on local or session storage. 

- [ ] What steps can you take in your web apps to keep your data secure?

Create protected routes and sending an authentication header with API calls.

- [ ] Describe how web servers work.

A device and/or program that is connected to the internet and hosts a website/app; the project code is served to the cleint upon request.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

PUT stands for the "U" because it is Updating a resources infomation. The DELETE stands for the "D" because it Deletes or Destroys data that lives elsewhere. 
